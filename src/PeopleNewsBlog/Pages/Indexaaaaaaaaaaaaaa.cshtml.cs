...
{
    public class IndexaaaaaaaaaaaaaaModel : PageModel
    {
        private readonly ILogger<IndexModel> _logger;
        private readonly ISettingsService _settingsService;
        private readonly ModelData.Data.ApplicationDbContext _context;

        public IndexaaaaaaaaaaaaaaModel(ILogger<IndexModel> logger, ISettingsService settingsService, ModelData.Data.ApplicationDbContext context)
        {
            _logger = logger;
