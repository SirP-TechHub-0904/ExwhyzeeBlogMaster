...
namespace AdminUI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [MaxLength(50, ErrorMessage = "Full name too long.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (!string.IsNullOrEmpty(Input.BotCheck))
            {
                ModelState.AddModelError("", "Bot detected.");
                return Page();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                user.City = Input.City; // or Input.City if separate
